...
function chooseWeb(){
    ...
    setTimeout(()=>{
        while (true){
            ...
            if((element[random]!=itemselect)) break;
        }
...
function winOrLose(winorlose){
    ...
    const color=['#FF0000','#1776FF']
    result.style='--color:'+color[winorlose]
    result.innerHTML='<h1>YOU '+results[winorlose]+'</h1> <a onclick="restartGame()" >PLAY AGAIN</a>'
}
